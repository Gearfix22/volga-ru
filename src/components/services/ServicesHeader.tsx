...
export const ServicesHeader: React.FC = () => {
  ...
  return (
    <div className="text-center mb-6 sm:mb-8 lg:mb-10 animate-fade-in px-1 sm:px-2">
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-russian-cream leading-relaxed text-shadow-elegant max-w-3xl mx-auto px-1">
